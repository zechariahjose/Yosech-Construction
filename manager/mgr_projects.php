...
";
$allProjects = mysqli_query($conn, $allProjectsSql);

// Active (Ongoing) projects only — for the highlighted section
$activeProjectsSql = "
    SELECT p.*, a.ApplicationType, a.ProjectTitle, a.ProjectLocation,
           c.Client_FirstName, c.Client_LastName, c.Client_ContactNumber
    FROM Project p
...
";
$activeProjects = mysqli_query($conn, $activeProjectsSql);

$mgrActiveNav  = 'projects';
$mgrPageTitle  = 'Projects';
$mgrPageSubtitle = 'Track site progress, post field updates, and manage all project records.';
$mgrPageActions = '
...
<div style="margin-bottom: 8px;">
    ...
    <p class="admin-page-sub" style="margin-bottom:16px;">Currently ongoing sites.</p>
</div>
...
<div style="margin-bottom: 8px;">
    ...
    <p class="admin-page-sub" style="margin-bottom:16px;">Complete project history across all statuses.</p>
</div>
