            ...
            <div class="admin-topbar-actions">
                ...
                <div id="ysc-restricted-modal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,.45);align-items:center;justify-content:center;" onclick="if(event.target===this)this.style.display='none'">
                    <div style="background:#fff;border-radius:10px;padding:36px 32px;max-width:380px;width:90%;box-shadow:0 8px 32px rgba(0,0,0,.18);text-align:center;">
                        <div style="width:52px;height:52px;border-radius:50%;background:#fff3e8;display:flex;align-items:center;justify-content:center;margin:0 auto 18px;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="none" viewBox="0 0 24 24" stroke="#f97316" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg>
                        </div>
                        <h2 style="font-size:1.05rem;font-weight:800;color:#111827;margin:0 0 10px;">Access Restricted</h2>
                        <p style="font-size:0.84rem;color:#6b7280;line-height:1.6;margin:0 0 24px;">The client interface is not accessible from the admin console. You are restricted to the dashboard and its management tools only.</p>
